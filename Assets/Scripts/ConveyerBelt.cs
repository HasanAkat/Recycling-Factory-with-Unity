...
namespace nickmaltbie.ScrollingShader
{
    ...
    public class ConveyerBelt : MonoBehaviour
    {
        ...
        /// <summary>
        /// The increment rate of velocity over time.
        /// </summary>
        [SerializeField]
        [Tooltip("Velocity increment rate over time.")]
        private float velocityIncrement = 0.01f;
        ...
        /// <summary>
        /// Kind of force used to move objects. <see cref="BeltForceMode" /> for more details on 
        ...
        {
            // Velocity artýþý
            velocity += velocityIncrement * Time.fixedDeltaTime;
